package termassigment.taxiclientgui2;
 ...
 */
public class TaxiClientGUI2 extends Block {
	...
	public final String DECLINE = "DECLINE";
	...
	/* The buttons */
	private JButton onDuty, offDuty, available, unavailable, confirm, decline;
	/**
	 * The log
	...
	public void show(String alias) {
		...
		decline = frame.createEventButton(DECLINE, "Decline");
		ClientFrame.growButton(confirm);
		ClientFrame.growButton(decline);
